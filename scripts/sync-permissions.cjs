...
const DEFAULT_PROFILES = {
  ...
  READ_ONLY: ['READ'],
  HR_MASTER: ['READ', 'CREATE', 'UPDATE', 'DELETE', 'EXPORT'],
  HR_EMPLOYEE: ['READ', 'CREATE', 'UPDATE', 'DELETE', 'EXPORT', 'GEN_PDF'],
  HR_CONTRACT: ['READ', 'CREATE', 'UPDATE', 'DELETE', 'GEN_PDF', 'UPDATE_STATUS'],
  HR_ATTENDANCE: ['READ', 'CREATE', 'UPDATE', 'DELETE', 'GEN_PDF', 'EXPORT'],
  HR_LEAVE: ['READ', 'CREATE', 'UPDATE', 'DELETE', 'APPROVE', 'REJECT', 'CANCEL', 'GEN_PDF'],
  HR_PAYROLL_PERIOD: ['READ', 'CREATE', 'UPDATE', 'DELETE', 'CALCULATE', 'VALIDATE', 'PAY', 'CLOSE', 'EXPORT', 'REPORT'],
  HR_PAYSLIP: ['READ', 'CREATE', 'UPDATE', 'DELETE', 'CALCULATE', 'VALIDATE', 'PAY', 'GEN_PDF', 'EXPORT'],
};
