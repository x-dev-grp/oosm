package com.xdev.ooms.inventory.ligneconditionnement.entity;
...
public class LigneConditionnement extends BaseEntity {
    ...
    public LigneConditionnement() {
    }

    public LigneConditionnement(String code, String nom, String description, Statue etat, Integer vitesseNominale, Integer tempsPreparation, Integer tempsNettoyage, String responsable, Date dateDerniereMaintenance, Date dateProchaineMaintenance, String notes, boolean actif) {
        this.code = code;
        this.nom = nom;
