...
import com.xdev.ooms.conditioning.repository.LabelSourceRepository;
import com.xdev.ooms.conditioning.repository.LigneOFRepository;
...
import com.xdev.ooms.conditioning.shipping.repository.ShippingInfoRepository;
...
public class GlobalSearch implements GlobalCodeSearchContributor {
    ...
    private Optional<QrResolveResponse> resolveExpedition(String code) {
        ...
        return entity.map(expedition -> response(
                ...
                code,
                expedition.getId(),
                expedition.getExpeditionNumber(),
                expedition.getStatus() != null ? expedition.getStatus().name() : null,
                "/projets/detail",
                expedition.getProjet() != null ? "/projets/detail/" + expedition.getProjet().getId() + "/expedition" : "/projets",
                null
        ));
    }
