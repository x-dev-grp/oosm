...
public class ProjetService extends BaseServiceImpl<Projet, ProjetDto, ProjetDto> {
    ...
    private ProjetDto toDto(Projet projet) {
        ...
        if (projet.getReservations() != null) {
            List<com.xdev.ooms.conditioning.projet.dto.ProjetReservationDto> rList = new ArrayList<>();
            for (ProjetReservation pr : projet.getReservations()) {
                com.xdev.ooms.conditioning.projet.dto.ProjetReservationDto prDto = new com.xdev.ooms.conditioning.projet.dto.ProjetReservationDto();
