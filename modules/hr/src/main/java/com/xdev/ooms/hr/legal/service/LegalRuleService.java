...
@Service
public class LegalRuleService extends BaseServiceImpl<LegalRule, LegalRuleDto, LegalRuleDto> {

    public LegalRuleService(BaseRepository<LegalRule> repository, ModelMapper modelMapper) {
        super(repository, modelMapper);
    }

    @Override
    public Set<Action> actionsMapping(LegalRule entity) {
