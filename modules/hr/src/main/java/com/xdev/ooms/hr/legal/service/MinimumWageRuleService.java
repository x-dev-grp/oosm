...
@Service
public class MinimumWageRuleService extends BaseServiceImpl<MinimumWageRule, MinimumWageRuleDto, MinimumWageRuleDto> {

    public MinimumWageRuleService(BaseRepository<MinimumWageRule> repository, ModelMapper modelMapper) {
        super(repository, modelMapper);
    }

    @Override
    public Set<Action> actionsMapping(MinimumWageRule entity) {
