...
@Service
public class SocialSecurityConfigurationService extends BaseServiceImpl<SocialSecurityConfiguration, SocialSecurityConfigurationDto, SocialSecurityConfigurationDto> {

    public SocialSecurityConfigurationService(BaseRepository<SocialSecurityConfiguration> repository, ModelMapper modelMapper) {
        super(repository, modelMapper);
    }

    @Override
    public Set<Action> actionsMapping(SocialSecurityConfiguration entity) {
