...
public final class HrPermissionSupport {
    ...
    public static boolean hasAction(String resource, Action action) {
        ...
        Set<String> permitted = extractResourcePermissions(authentication, resource);
        return permitted.contains(action.name());
    }

    private static String extractResourceRole(Authentication authentication) {
    ...
    private static Set<String> extractResourcePermissions(Authentication authentication, String resource) {
        ...
        return rawAuthorities.stream()
                ...
                .map(HrPermissionSupport::extractPermissionFromAuthority)
                .filter(Objects::nonNull)
    ...
    private static String extractPermissionFromAuthority(String authority) {
