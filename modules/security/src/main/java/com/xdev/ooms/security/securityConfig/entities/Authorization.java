package com.xdev.ooms.security.securityConfig.entities;
...
public class Authorization {
    ...
    public void setOidcIdTokenMetadata(byte[] idTokenMetadata) {
        this.oidcIdTokenMetadata = idTokenMetadata;
    }

    public byte[] getOidcIdTokenClaims() {
        return oidcIdTokenClaims;
    }

    public void setOidcIdTokenClaims(byte[] idTokenClaims) {
